@echo off
:: BEGIN ODYSSEY LOGIN - paste immediately after @echo off
:: Local deterrent only. Anyone who can edit this file can bypass login.
powershell.exe -NoLogo -NoProfile -ExecutionPolicy Bypass -EncodedCommand 
if errorlevel 1 (
    echo [ERROR] Access denied. Setup will not run.
    pause
    exit /b 1
)
:: END ODYSSEY LOGIN
...
echo.
echo [OK] BitLocker encryption started and will continue in the background.
manage-bde -status C:
pause
goto ADMIN_MENU
...
if not defined NewName goto ADMIN_MENU
...
if errorlevel 1 (
    ...
    echo [OK] Computer renamed. Restart Windows to apply the new name.
)
pause
goto ADMIN_MENU
...
echo.
echo [OK] BitLocker decryption started and will continue in the background.
manage-bde -status C:
pause
goto MENU
...
if exist "!wordPath!" call :CreateShortcut "Word" "!wordPath!"
if exist "!excelPath!" call :CreateShortcut "Excel" "!excelPath!"
if exist "!outlookPath!" call :CreateShortcut "Outlook" "!outlookPath!"
...
echo [OK] Available desktop shortcuts created.
echo [NOTE] Automatic Start/Taskbar pinning is skipped because modern Windows blocks it.
pause
...
set "shortcutName=%~1"
set "targetPath=%~2"
powershell -NoProfile -ExecutionPolicy Bypass -Command "$d=[Environment]::GetFolderPath('Desktop'); $s=(New-Object -ComObject WScript.Shell).CreateShortcut((Join-Path $d '%shortcutName%.lnk')); $s.TargetPath='%targetPath%'; $s.Save()"
exit /b 0
...
set "targetPath=%~2"
set "arguments=%~3"
powershell -NoProfile -ExecutionPolicy Bypass -Command "$d=[Environment]::GetFolderPath('Desktop'); $s=(New-Object -ComObject WScript.Shell).CreateShortcut((Join-Path $d '%shortcutName%.lnk')); $s.TargetPath='%targetPath%'; $s.Arguments='%arguments%'; $s.Save()"
exit /b 0
...
if not defined ver_major (
    echo [WARN] Could not determine the Windows version. Continuing setup.
